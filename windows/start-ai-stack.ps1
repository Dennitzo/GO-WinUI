...
& (Join-Path $PSScriptRoot 'start-lmstudio-server.ps1')
...
Write-Host "GO AI stack is starting at http://${ServerIp}:8080; model inference is managed by LM Studio." -ForegroundColor Green
